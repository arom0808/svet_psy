    ...
    <div class="bg-white header flex justify-center m-12 flex-col items-center sm:flex-row sm:justify-between">
        ...
        <div class="text-end">
            {{-- <form class="flex w-full max-w-sm space-x-3"> --}}
                <div class=" relative ">
                    <input wire:change="search($event.target.value)" onchange="this.blur(); history.pushState(null, null, '/quotes/search/'+this.value);" type="text" id="&quot;form-subscribe-Search"
            ...
            <div class="w-full flex flex-col md:flex-row gap-4 mb-8 md:mb-0 flex-between items-center p-8 m-4">
                <div class="bg-white dark:bg-gray-800 w-72 shadow-lg mx-auto rounded-xl p-4">
                    <p class="text-gray-600 dark:text-white">
                        <span class="font-bold text-indigo-500 text-lg">“</span>{{$quote->text}}<span class="font-bold text-indigo-500 text-lg">”</span>
                    </p>
                    <div class="flex items-center mt-4">
                        <div class="block relative">
                            <img alt="profil" src="{{$quote->publisher->profile_photo_url}}" class="mx-auto object-cover rounded-full h-10 w-10 " />
                        </div>
