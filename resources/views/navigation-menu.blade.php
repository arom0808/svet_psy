<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (request()->is('admin*'))
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('admin_users') }}" :active="request()->is('admin/users*')">
                            {{ __('Пользователи') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('admin_quotes') }}" :active="request()->is('admin/quotes*')">
                            {{ __('Цитаты') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                @else
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('quotes') }}"
                            :active="request()->routeIs('quotes') || request()->routeIs('quotes_search')">
                            {{ __('Цитаты') }}
                        </x-jet-nav-link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('articles') }}"
                            :active="request()->routeIs('articles') || request()->routeIs('article') || request()->routeIs('articles_search')">
                            {{ __('Статьи') }}
                        </x-jet-nav-link>
                    </div>
            ...
            {{-- <svg xmlns="http://www.w3.org/2000/svg" wire:click="$emit('open-categories-modal')" width="20" height="20" fill="none" viewBox="0 0 24 24" class="cursor-pointer self-center rounded-full hover:bg-gray-800 hover:text-white" stroke="currentColor"> --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @if (request()->is('admin*'))
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('admin_users') }}" :active="request()->is('admin/users*')">
                    {{ __('Пользователи') }}
                </x-jet-responsive-nav-link>
            </div>
            <div class="pt-2 pb-3 space-y-1">
        ...
        @else
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('about-me') }}" :active="request()->routeIs('about-me')">
                    {{ __('Обо мне') }}
                </x-jet-responsive-nav-link>
            </div>
            @if (Auth::check())
